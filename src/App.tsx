             ...
             <div className="space-y-6">
               ...
               <div className="bg-white p-6 rounded-xl shadow-md">
                 ...
                 <p className="text-gray-600">
                   ...
                   It's not a platform built with Muslim listeners in mind.
                 </p>
               </div>
               ...
               <div className="bg-white p-6 rounded-xl shadow-md">
                 ...
                 <p className="text-gray-600">
                   Finding quality nasheeds means searching across dozens of websites, downloading from unreliable sources, or streaming from 
                   platforms that don't understand your needs. It's time-consuming and frustrating.
                 </p>
               </div>
             </div>
         ...
         <div className="container mx-auto px-6">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             <div className="bg-emerald-50 p-8 rounded-xl">
               ...
               <p className="text-gray-600">
                 Our platform is dedicated exclusively to Islamic nasheeds, ensuring all content aligns with Islamic values.
               </p>
             </div>
             ...
             <div className="bg-emerald-50 p-8 rounded-xl">
               ...
               <h3 className="text-xl font-semibold text-gray-900 mb-3">Ad-Free Experience</h3>
               <p className="text-gray-600">
                 No interruptions from music ads that could compromise your halal listening experience.
               </p>
             </div>
       ...
       <section id="testimonials" className="py-16 md:py-24 bg-white">
         <div className="container mx-auto px-6">
           <div className="text-center mb-16">
             ...
             <p className="text-lg text-gray-600 max-w-2xl mx-auto">
               Join the nasheed revolution by registering for beta or directly email the founders working on this with your thoughts.
             </p>
